...
namespace hrose
{
    internal class hrosne
    {
        ...
        public hrosne(string inpname, string inpspecial, string inpcolor, string inpsymbol)
        {
            name = inpname;
            special = inpspecial;
            color = inpcolor;
        ...
        {
            string[] hoong = { name, special, color, specialstate, symbol };
            return hoong;
        }
